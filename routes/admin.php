...
Route::group(['middleware' => ['installer']], function () {
    ...
    Route::get('/product_exceed', function () {
        return view('errors.product_exceed');
    });
    ...
    Route::group(['prefix' => 'admin/media', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
        ...
        Route::post('/uploaddesign', 'MediaController@uploaddesign')->middleware('add_media');
    ...
    Route::group(['prefix' => 'admin/products', 'middleware' => 'auth', 'namespace' => 'AdminControllers'], function () {
       /* Mitali - bulk-upload */
       Route::get('/import', 'ProductController@import')->name('admin-prod-import');
       Route::post('/import-submit', 'ProductController@importSubmit')->name('admin-prod-importsubmit');
   

         /* Mitali - bulk-upload */
        Route::get('/display', 'ProductController@display')->middleware('view_product')->name('admin-prod-index');
        ...
        Route::group(['prefix' => 'attach/attribute'], function () {
            ...
            Route::group(['prefix' => 'images'], function () {
                Route::get('/display/{id}/', 'ProductController@displayProductAttributeImages')->middleware('view_product');
                Route::get('/add/{id}/', 'ProductController@addProductAttributeImages')->middleware('add_product');
                Route::post('/insertproductimage', 'ProductController@insertProductAttributeImages')->middleware('add_product');
                Route::get('/editproductimage/{id}', 'ProductController@editProductAttributeImages')->middleware('edit_product');
                Route::post('/updateproductimage', 'ProductController@updateProductAttributeImages')->middleware('edit_product');
                Route::post('/deleteproductimagemodal', 'ProductController@deleteProductAttributeImagesmodal')->middleware('edit_product');
                Route::post('/deleteproductimage', 'ProductController@deleteProductAttributeImages')->middleware('edit_product');
            });
...
////////////////////////////////////////////////////////////////////////////////////
        ...
        Route::get('/uploaded-designs', 'PagesController@uploadedDesigns')->middleware('view_product');
