         ...
         <div class="col-md-12 p-0">
             <div class="nav" role="tablist" id="tabCarousel">
                 ...
                 @if($result['top_seller']['success']==1)
                  <a class="nav-link btn  " data-toggle="tab" href="#featured" role="tab" ><span data-toggle="tooltip" data-placement="bottom" title="@lang('website.TopSales')">@lang('website.TopSales')</span></a>
                 @endif
                 @if($result['special']['success']==1)
                  <a class="nav-link btn active show"  data-toggle="tab" href="#special" role="tab" aria-controls="special" aria-selected="true" ><span data-toggle="tooltip" data-placement="bottom" title="@lang('website.Special')">@lang('website.Special')</span></a> 
                 @endif
