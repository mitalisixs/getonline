            ...
            <div class="col-12 col-lg-3">
                <div class="single-footer single-footer-left">
                    ...
                    <ul class="links-list pl-0 mb-0">
                        ...
                        <li> <a href="{{ URL::to('/page?name=faq') }}"><i class="fa fa-angle-right"></i>Frequently Asked
                                Questions</a> </li>
                ...
                <div class="footer-block">
                    <div class="single-footer single-footer-left">
                        ...
                        <ul class="links-list pl-0 mb-0">
                            ...
                            <li> <a href="{{ URL::to('/page?name=bulk-orders') }}"><i class="fa fa-angle-right"></i>Bulk
                                    Order</a> </li>
                ...
                <div class="single-footer">
                            ...
                            <div class="block">
                                <form class="form-inline">
                                    <div class="search">
                                        ...
                                        <div class="alert alert-success alert-dismissible success-subscribte"
                                            role="alert" style="opacity: 500; display: none;"></div>

                                        <div class="alert alert-danger alert-dismissible error-subscribte"
                                            role="alert" style="opacity: 500; display: none;"></div>
                                    </div>
                                </form>
                            </div>
                    ...
                    <div class="socials">
                        ...
                        <ul class="list">
                            ...
                            <li>
                                @if (
                                    !empty($result['commonContent']['settings']['google_url']) &&
                            ...
                            <li>
                                @if (
                                    !empty($result['commonContent']['settings']['twitter_url']) &&
                            ...
                            <li>
                                @if (
                                    !empty($result['commonContent']['settings']['linked_in']) &&
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="footer-info">
                            ©&nbsp;@lang('website.Copy Rights') - {{ ucfirst($result['commonContent']['setting'][18]->value) }}
                            DESIGN BY <a href="http://getonlinestore.in">GetOneline</a>
                        </div>
