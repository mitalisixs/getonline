                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                {!! Form::text($result['settings'][128]->name, $result['settings'][128]->value, array('class'=>'form-control', 'id'=>$result['settings'][12]->name)) !!}
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                {!! Form::text($result['settings'][129]->name, $result['settings'][129]->value, array('class'=>'form-control', 'id'=>$result['settings'][5]->name)) !!}
                                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">
