                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-10 col-md-4">
                                    ...
                                    <!-- Modal -->
                                        ...
                                        <br>
                                        <div>
                                        {!! Form::hidden('oldImage', isset($result['languages'][0]->image)?$result['languages'][0]->image:'', array('id'=>'oldImage')) !!}
                                        @if(isset($result['languages'][0]->path) && ($result['languages'][0]->path!== null))
