    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ URL::to('admin/products/attach/attribute/display') }}"><i class="fa fa-database"></i>{{ trans('labels.ListingAllProducts') }}</a></li>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            {!! Form::open(array('url' =>'admin/products/attach/attribute/images/updateproductimage', 'name'=>'editImageFrom', 'id'=>'editImageFrom', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
                                            {!! Form::hidden('products_id',  $products_images[0]->product_attribute_id, array('class'=>'form-control', 'id'=>'products_id')) !!}
                                              ...
                                              <div class="form-group" id="imageIcone">
                                                  ...
                                                  <div class="col-sm-10 col-md-8">
                                                      ...
                                                      <div id="imageselected">
                                                        {!! Form::button(trans('labels.AddImage'), array('id'=>'newIcon','class'=>"btn btn-primary field-validate", 'data-toggle'=>"modal", 'data-target'=>"#ModalmanufacturedICone" )) !!}
                                                        <br>
							     ...
							     {{--</span>--}}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-8 float-right">
                                                {{--<a type="button" class="btn btn-default float-right" href="{{url('admin/products/attach/attribute/images/display')}}/{{$products_id}}" >{{ trans('labels.back') }} </a>--}}
                                                <a type="button" class="btn btn-default"  href="{{url('admin/products/attach/attribute/images/display')}}/{{$products_images[0]->product_attribute_id}}">{{ trans('labels.Close') }}</a>
