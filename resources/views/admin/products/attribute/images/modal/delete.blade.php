...
{!! Form::open(array('url' =>'admin/products/attach/attribute/images/deleteproductimage', 'name'=>'deleteImageForm', 'id'=>'deleteImageForm', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')) !!}
