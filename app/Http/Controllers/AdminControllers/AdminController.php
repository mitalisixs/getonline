   ...
   public function profile(Request $request){
	...
	public function addrole(Request $request){
		...
		if(count($roles)>0){
			...
			$currency_view =isset( $roles[0]->currency_view)? $roles[0]->currency_view:'0';
			$currency_create = isset( $roles[0]->currency_create )?$roles[0]->currency_create :'0';
		...
		$result2[22]['link_name'] = 'currency';
		$result2[22]['permissions'] = array(
					'0'=>array('name'=>'currency_view','value'=>$currency_view),
					'1'=>array('name'=>'currency_create','value'=>$currency_create),
	...
	public function addnewroles(Request $request){
		...
		$roles = DB::table('manage_role')->where('user_types_id',$request->user_types_id)->insert([
						...
						'currency_view' => $request->currency_view,
