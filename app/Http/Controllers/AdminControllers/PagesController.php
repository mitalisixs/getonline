...
class PagesController extends Controller
{
    ...
    public function uploadedDesigns(Request $request)
    {

        $title = array('pageTitle' => "Uploaded Designs");
        $UploadDesign = new UploadDesign();
        $result['designs'] = $UploadDesign->getter();
        $result['commonContent'] = $this->Setting->commonContent();
        return view("admin.pages.designs", $title)->with('result', $result);
