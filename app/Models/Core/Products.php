...
class Products extends Model
{
  ...
  public function insert($request){
    ...
    $products_id = DB::table('products')->insertGetId([
        'product_sku'=>isset($request->product_sku)?$request->product_sku:'',
    ...
    foreach($languages as $languages_data){
        ...
        if(isset($request->$products_left_banner) && $request->$products_left_banner !== null){
            $leftBanner = $request->$products_left_banner;
        }else{
            $leftBanner = '';
        }
        if(isset($request->$products_right_banner) && $request->$products_right_banner !== null){
  ...
  public function insertWithArray($request){
  ...
  public function deletedefaultattribute($request){
    ...
    $myVaralter = new AlertController($setting);
              ...
              $products_attributes = DB::table('products_attributes')
                  ...
                  ->where('products_options_values_descriptions.language_id', '=', $language_id)
                  ->where('products_attributes.products_id', '=', $request->products_id)
                  ->where('products_attributes.is_default', '=', $request->is_default)
                  ->orderBy('products_attributes_id', 'DESC')
                  ->get();
                  return $products_attributes;
  }
  ...
  public function displayProductAttributeImages($request){
    $products_id = $request->id;
    $result['data'] = array('products_id'=>$products_id);
    $products_images = DB::table('products_attribute_images')
        ->LeftJoin('image_categories', function ($join) {
            $join->on('image_categories.image_id', '=', 'products_attribute_images.image')
                ->where(function ($query) {
                    $query->where('image_categories.image_type', '=', 'THUMBNAIL')
                        ->where('image_categories.image_type', '!=', 'THUMBNAIL')
                        ->orWhere('image_categories.image_type', '=', 'ACTUAL');
        ...
        ->where('product_attribute_id', '=', $products_id)
        ->select('products_attribute_images.*', 'image_categories.path')
        ->orderBy('sort_order', 'asc')
        ->get();
    $result['products_images'] = $products_images;
    return $result;
  ...
  public function insertProductAttributeImages($request){
    ...
    $product_id = $request->products_id;
         ...
         $sort_id = DB::table('products_attribute_images')
                       ->where('product_attribute_id',$product_id)
                       ->select('sort_order')
                       ->orderBy('id', 'desc')
                       ->first();
         ...
         DB::table('products_attribute_images')->insert([
  ...
  public function editProductAttributeImages($id){
    ...
    $products_images = DB::table('products_attribute_images')
        ...
        ->where('products_attribute_images.id', '=', $id)
        ->select('products_attribute_images.*', 'image_categories.path')
        ->get();
  ...
  public function updateProductAttributeImages($request){
    $setting = new Setting();
    $myVarsetting = new SiteSettingController($setting);
    $myVaralter = new AlertController($setting);
      ...
      $product_id = $request->products_id;
      DB::table('products_attribute_images')->where('product_attribute_id', '=', $request->products_id)->where('id', '=', $request->id)
          ->update([
              'image' => $uploadImage,
              'htmlcontent' => $request->htmlcontent,
              'sort_order' => $request->sort_order,
          ...
          $products_images = DB::table('products_attribute_images')
              ...
              ->where('product_attribute_id', '=', $request->products_id)
              ->select('products_attribute_images.*', 'image_categories.path')
              ->orderBy('sort_order', 'ASC')
              ->get();
      $result['products_images'] = $products_images;
  ...
  public function deleteProductAttributeImages($request){
        DB::table('products_attribute_images')
        ->where([
            'product_attribute_id' => $request->products_id,
            'id' => $request->id
        ])
        ->delete();
  }
