  ...
  <div class="container"> 
    <div class="row">
      <div class="col-12 col-sm-12">
        ...
        <?php /*     
        @if(!empty($result['commonContent']['settings']['latitude']) and  !empty($result['commonContent']['settings']['longitude']) && !empty($result['commonContent']['settings']['google_map_api']))
          ...
          <div class="col-12 col-lg-3">
              ...
              <div class="">
                  <ul class="contact-info 111 pl-0 mb-0"  >
                      <li> <i class="fas fa-mobile-alt"></i><span><a href="tel:<?php echo e($result['commonContent']['setting'][11]->value); ?>"><?php echo $result['commonContent']['setting'][11]->value; ?></a></span> </li>
                      <li> <i class="fas fa-map-marker"></i><a style="cursor: default;margin-left:10px; " href="javascript:void(0)"><?php echo e($result['commonContent']['setting'][18]->value); ?><br><?php echo e($result['commonContent']['setting'][4]->value); ?>,<br/><?php echo e($result['commonContent']['setting'][5]->value); ?>,<br/><?php echo e($result['commonContent']['setting'][6]->value); ?>,<br/><?php echo e($result['commonContent']['setting'][7]->value); ?>,<br/><?php echo e($result['commonContent']['setting'][8]->value); ?></a></span> </li>
...
</section><?php /**PATH /var/www/vhosts/centrifugalproducts.com/httpdocs/resources/views/web/contacts/contact1.blade.php ENDPATH**/ ?>