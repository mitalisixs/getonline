                         ...
                         <div class="box-body">
                            ...
                            <hr> 
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-sm-10 col-md-4">
                                    <?php echo Form::text('phone',  '', array('class'=>'form-control phone-validate', 'id'=>'phone')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\getonline\resources\views/admin/admins/add.blade.php ENDPATH**/ ?>