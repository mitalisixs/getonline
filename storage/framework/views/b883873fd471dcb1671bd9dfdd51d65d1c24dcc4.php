    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="<?php echo e(URL::to('admin/products/attach/attribute/display')); ?>"><i class="fa fa-database"></i><?php echo e(trans('labels.ListingAllProducts')); ?></a></li>
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <?php echo Form::open(array('url' =>'admin/products/attach/attribute/images/updateproductimage', 'name'=>'editImageFrom', 'id'=>'editImageFrom', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>

                                            <?php echo Form::hidden('products_id',  $products_images[0]->product_attribute_id, array('class'=>'form-control', 'id'=>'products_id')); ?>
                                              ...
                                              <div class="form-group" id="imageIcone">
                                                  ...
                                                  <div class="col-sm-10 col-md-8">
                                                      ...
                                                      <div id="imageselected">
                                                        <?php echo Form::button(trans('labels.AddImage'), array('id'=>'newIcon','class'=>"btn btn-primary field-validate", 'data-toggle'=>"modal", 'data-target'=>"#ModalmanufacturedICone" )); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-8 float-right">
                                                ...
                                                <a type="button" class="btn btn-default"  href="<?php echo e(url('admin/products/attach/attribute/images/display')); ?>/<?php echo e($products_images[0]->product_attribute_id); ?>"><?php echo e(trans('labels.Close')); ?></a>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\getonline\resources\views/admin/products/attribute/images/edit.blade.php ENDPATH**/ ?>