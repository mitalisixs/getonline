                                    ...
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::text($result['settings'][75]->name,  stripslashes($result['settings'][75]->value), array('class'=>'form-control', 'id'=>$result['settings'][75]->name)); ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <?php echo Form::textarea($result['settings'][76]->name,  stripslashes($result['settings'][76]->value), array('class'=>'form-control', 'id'=>'editor')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/centrifugalprodu/public_html/resources/views/admin/settings/general/seo.blade.php ENDPATH**/ ?>