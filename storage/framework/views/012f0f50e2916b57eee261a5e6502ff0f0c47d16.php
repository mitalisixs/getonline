                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="<?php echo e($result['settings'][62]->name); ?>" class="form-control">
                                                        <option <?php if($result['settings'][62]->value == '1'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="1"> <?php echo e(trans('labels.enable')); ?></option>
                                                        <option <?php if($result['settings'][62]->value == '0'): ?>
                                                                selected
                                                                <?php endif; ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\getonline\resources\views/admin/settings/general/googleSettings.blade.php ENDPATH**/ ?>