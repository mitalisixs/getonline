                            ...
                            <div class="row">
                            	...
                            	<?php echo e(trans('labels.AddOptionNameText')); ?>
                                  ...
                                  <?php echo e(trans('labels.AddOptionValueText')); ?></span>
                                                    ...
                                                    <div class="alert alert-danger addDefaultError" style="display: none; margin-bottom: 0;" role="alert">Already Exist<i class="icon fa fa-ban"></i><span></span> </div>
                                                </div>
                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody class="contentAttribute">
                                            <?php echo $__env->make('admin.products.attribute.list_product_attribute', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\getonline\resources\views/admin/products/attribute/add.blade.php ENDPATH**/ ?>