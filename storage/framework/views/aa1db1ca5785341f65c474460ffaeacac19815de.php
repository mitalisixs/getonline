                                              ...
                                              <div class="form-group" hidden>
                                                  ...
                                                  <div class="col-sm-10 col-md-4">
                                                      <select name="role_id" class="form-control" >
                                                          <option value="2" <?php if($result['orders_status']->role_id==2): ?> selected <?php endif; ?>><?php echo e(trans('labels.General')); ?></option>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/centrifugalprodu/public_html/resources/views/admin/Orders/editorderstatus.blade.php ENDPATH**/ ?>