                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="name" class="col-sm-2 col-md-3 control-label">Product SKU<span style="color:red;">*</span></label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <?php echo Form::text('product_sku',  $result['product'][0]->product_sku, array('class'=>'form-control field-validate', 'id'=>'product_sku')); ?>

                                                        <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;">
                                                            Enter the SKU
                                                        </span>
                                                        <span class="help-block hidden"> Enter the SKU</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/centrifugalproducts.com/httpdocs/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>