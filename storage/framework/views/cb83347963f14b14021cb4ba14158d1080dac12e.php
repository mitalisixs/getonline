                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <select name="<?php echo e($result['settings'][79]->name); ?>" class="form-control">
                                                        <option <?php if($result['settings'][79]->value == 'name'): ?>
                                                                selected
                                                                <?php endif; ?>
                                                                value="name"> <?php echo e(trans('labels.Name')); ?></option>
                                                        <option <?php if($result['settings'][79]->value == 'logo'): ?>
                                                                selected
                                                                <?php endif; ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    <input type="text" id="<?php echo e($result['settings'][80]->name); ?>" name="<?php echo e($result['settings'][80]->name); ?>" class="form-control" value="<?=stripslashes($result['settings'][80]->value)?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <br>
                                                    <?php echo Form::hidden('oldImage',  $result['settings'][16]->value , array('id'=>$result['settings'][16]->name)); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/centrifugalprodu/public_html/resources/views/admin/settings/general/websetting.blade.php ENDPATH**/ ?>