                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <?php echo Form::open(array('url' =>'admin/products/attach/attribute/images/insertproductimage', 'name'=>'addImageFrom', 'id'=>'addImageFrom', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
							     ...
							     <?php echo e(trans('labels.ImageDescription')); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a type="button" class="btn btn-default float-right" href="<?php echo e(url('admin/products/attach/attribute/images/display')); ?>/<?php echo e($products_id); ?>" ><?php echo e(trans('labels.back')); ?> </a>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\getonline\resources\views/admin/products/attribute/images/add.blade.php ENDPATH**/ ?>