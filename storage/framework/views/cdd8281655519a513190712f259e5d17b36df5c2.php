                                            ...
                                            <div class="form-group">
                                              ...
                                              <div class="col-sm-10 col-md-4">
                                                <select required id="select_id" onchange="showPageSelect()" class="form-control" name="type">
                                                      ...
                                                      <option <?php if($result['menus'][0]->type == 5): ?> selected <?php endif; ?> value="5"><?php echo e(trans('labels.Page')); ?></option>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/centrifugalprodu/public_html/resources/views/admin/menus/edit.blade.php ENDPATH**/ ?>