...
function getQuantity(){
	...
	jQuery.ajax({
		...
		dataType: "json",
		success: function (res) {
			//console.log(res.imageHtml);
			if(res.imageHtml!=""){
				destroy_product_slider();
				$("#product_image_div").html(res.imageHtml);
				apply_product_slider();
...
function destroy_product_slider() {
...
<?php /**PATH /var/www/vhosts/centrifugalproducts.com/httpdocs/resources/views/web/common/scripts.blade.php ENDPATH**/ ?>