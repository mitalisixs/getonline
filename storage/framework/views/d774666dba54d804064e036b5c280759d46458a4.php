                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            <select name="web_color_style" class="form-control">
                                                ...
                                                <option <?php if($data['settings'][81]->value == 'app.theme.19'): ?>
                                                 ...
                                                 <option <?php if($data['settings'][81]->value == 'app.theme.20'): ?>
                                                          selected
                                                          <?php endif; ?>
                                                          value="app.theme.20"> SLD FAB </option>
                                      ...
                                      <div class="form-group">
                                          ...
                                          <div class="col-sm-10 col-md-4">
                                            <select name="web_card_style" class="form-control">
                                              <option <?php if($result['commonContent']['setting']['web_card_style'] == '1'): ?>
                                                selected
                                                <?php endif; ?>
                                                value="1"> <?php echo app('translator')->get('labels.Style1'); ?></option>    
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '2'): ?>
                                                    selected
                                                    <?php endif; ?>
                                                    value="2"> <?php echo app('translator')->get('labels.Style2'); ?></option>    
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '3'): ?>
                                                    selected
                                                    <?php endif; ?>
                                                    value="3"> <?php echo app('translator')->get('labels.Style3'); ?></option>   
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '4'): ?>
                                                    selected
                                                    <?php endif; ?>
                                                    value="4"> <?php echo app('translator')->get('labels.Style4'); ?></option>  
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '5'): ?>
                                                    selected
                                                    <?php endif; ?>
                                                    value="5"> <?php echo app('translator')->get('labels.Style5'); ?></option>   
                                                    
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '6'): ?>
                                                    selected
                                                    <?php endif; ?>
                                                    value="6"> <?php echo app('translator')->get('labels.Style6'); ?></option>   
                                                    
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '7'): ?>
                                                selected
                                                <?php endif; ?>
                                                value="7"> <?php echo app('translator')->get('labels.Style7'); ?></option>    
                                                
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '8'): ?>
                                                selected
                                                <?php endif; ?>
                                                value="8"> <?php echo app('translator')->get('labels.Style8'); ?></option>     
                                                
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '9'): ?>
                                                selected
                                                <?php endif; ?>
                                                value="9"> <?php echo app('translator')->get('labels.Style9'); ?></option>               
                                                
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '10'): ?>
                                                selected
                                                <?php endif; ?>
                                                value="10"> <?php echo app('translator')->get('labels.Style10'); ?></option>   
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '11'): ?>
                                                selected
                                                <?php endif; ?>
                                                value="11"> <?php echo app('translator')->get('labels.Style11'); ?></option> 
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '12'): ?>
                                                selected
                                                <?php endif; ?>
                                                value="12"> <?php echo app('translator')->get('labels.Style12'); ?></option>
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '13'): ?>
                                                selected
                                                <?php endif; ?>
                                                value="13"> <?php echo app('translator')->get('labels.Style13'); ?></option>
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '14'): ?>
                                                selected
                                                <?php endif; ?>
                                                value="14"> <?php echo app('translator')->get('labels.Style14'); ?></option>
                                                <option <?php if($result['commonContent']['setting']['web_card_style'] == '15'): ?>
                                                selected
                                                <?php endif; ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/centrifugalprodu/public_html/resources/views/admin/theme/index.blade.php ENDPATH**/ ?>