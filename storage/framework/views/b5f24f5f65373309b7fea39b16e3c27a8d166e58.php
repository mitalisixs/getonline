            ...
            <div class="row align-items-center">
                <div class="col-12">
                   <div class="footer-info">
                      ©&nbsp;<?php echo app('translator')->get('website.Copy Rights'); ?> - <?php echo e(ucfirst($result['commonContent']['setting'][18]->value)); ?> DESIGN BY  <a href="http://getonlinestore.in">GetOneline</a>
                  </div>
...
<?php /**PATH /var/www/vhosts/centrifugalproducts.com/httpdocs/resources/views/web/footers/footer6.blade.php ENDPATH**/ ?>