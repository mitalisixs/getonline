         ...
         <div class="col-md-12 p-0">
             <div class="nav" role="tablist" id="tabCarousel">
                 ...
                 <?php if($result['top_seller']['success']==1): ?>
                  <a class="nav-link btn  " data-toggle="tab" href="#featured" role="tab" ><span data-toggle="tooltip" data-placement="bottom" title="<?php echo app('translator')->get('website.TopSales'); ?>"><?php echo app('translator')->get('website.TopSales'); ?></span></a>
                 <?php endif; ?>
                 <?php if($result['special']['success']==1): ?>
                  <a class="nav-link btn active show"  data-toggle="tab" href="#special" role="tab" aria-controls="special" aria-selected="true" ><span data-toggle="tooltip" data-placement="bottom" title="<?php echo app('translator')->get('website.Special'); ?>"><?php echo app('translator')->get('website.Special'); ?></span></a> 
                 <?php endif; ?>
           ...
           <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane fade active show" id="special">
              <div class="tab-carousel-js ">
...
<?php endif; ?>
<?php /**PATH /var/www/vhosts/centrifugalproducts.com/httpdocs/resources/views/web/product-sections/tab.blade.php ENDPATH**/ ?>