		...
		success: function (res) {
			...
			if(res.length != ''){
				...
				for (i = 0; i < res.length; ++i) {
					var j = i + 1;
					showData[i] = "<tr><td>"+j+"</td><td>"+res[i].products_options_name+"</td><td>"+res[i].products_options_values_name+"</td><td>"+res[i].price_prefix+" "+res[i].options_values_price+"</td><td>   <a class='btn btn-info' href ='<?php echo e(URL::to("admin/products/attach/attribute/images/display")); ?>/"+res[i].products_attributes_id+"' >Image</a> <a class='btn bg-light-blue editproductattributemodal' products_attributes_id = '"+res[i].products_attributes_id+"' products_id = '"+res[i].products_id+"'  language_id = '"+res[i].language_id+"' options_id= '"+res[i].options_id+"'><i class='fa fa-pencil-square-o' aria-hidden='true'></i>Edit</a> <a class='btn bg-red deleteproductattributemodal' products_attributes_id = '"+res[i].products_attributes_id+"' products_id = '"+res[i].products_id+"' ><i class='fa fa-trash' aria-hidden='true'></i>Delete</a></td></tr>";
...
// NORMAL FORM ENDS
	...
	$(document).on('click', '.deleteProductImagesAttributeModal', function(){
		var id = $(this).attr('id');
		var products_id = $(this).attr('products_id');
		$.ajax({
			url: '<?php echo e(URL::to("admin/products/attach/attribute/images/deleteproductimagemodal")); ?>',
			type: "POST",
			data: '&products_id='+products_id+'&id='+id,
			success: function (data) {
				$('.deleteImageEmbed').html(data);
				$('#deleteProductImagesAttributeModal').modal('show');
			},
			dataType: 'html'
		});
	});
...
<?php /**PATH /var/www/vhosts/centrifugalproducts.com/httpdocs/resources/views/admin/common/scripts.blade.php ENDPATH**/ ?>